...
export async function fetchJson<T>(
	...
	try {
		...
		// Some CMS sources respond 200 with an HTML error page (CAPTCHA,
		// rate-limit, WAF). res.json() then throws a cryptic "Unexpected token"
		// error — read as text first so we can surface a useful message.
